...
module.exports = {
    ...
    run: (client, message, args) => {
        if(!message.member.hasPermission("KICK_MEMBERS")) return message.inlineReply("You don't have permission to kick members.");
        ...
        if(!toKick.kickable){
            return message.inlineReply('<a:CoolX:807041416735621160> I cannot kick someone that is mod/admin. <a:CoolX:807041416735621160>');
        }
