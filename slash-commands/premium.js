...
module.exports = {
	name: 'premium',
	description:
		'Request a molaibot premium subscription from the molaibot staff.',
	options: [
		{
			name: 'userid',
	...
	run: (client, command) => {
		...
		const usrEmbed = new MessageEmbed()
			...
			.setTimestamp()
			.setDescription(
				`If your request is approved, you will recieve a DM telling you that it has been approved and that the guild has been given molaibot premium access.`
			);
